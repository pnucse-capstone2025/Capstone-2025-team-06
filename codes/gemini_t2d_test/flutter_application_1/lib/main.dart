...
Logged meals: 17''',
  ...
  Widget _prettyRenderer(Map<String, dynamic> data) {
    // Decide which renderer to use based on keys present
    ...
    } else if (data.containsKey('summary_highlights') && data.containsKey('suggested_daily_schedule')) {
